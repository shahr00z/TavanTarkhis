...
namespace TavanTarkhis.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: TavanTarkhis.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult Login(TavanTarkhis.Models.LoginModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Login);
        ...
        public override System.Web.Mvc.ActionResult Register(TavanTarkhis.Models.RegisterModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Manage(TavanTarkhis.Controllers.AccountController.ManageMessageId? message) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "message", message);
            return callInfo;
        }

        public override System.Web.Mvc.ActionResult Manage(TavanTarkhis.Models.LocalPasswordModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(TavanTarkhis.Models.RegisterExternalLoginModel model, string returnUrl) {
