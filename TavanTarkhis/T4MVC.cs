...
public static class MVC {
    public static TavanTarkhis.Controllers.AccountController Account = new TavanTarkhis.Controllers.T4MVC_AccountController();
    public static TavanTarkhis.Controllers.AdminController Admin = new TavanTarkhis.Controllers.T4MVC_AdminController();
    public static TavanTarkhis.Controllers.HomeController Home = new TavanTarkhis.Controllers.T4MVC_HomeController();
    public static TavanTarkhis.Controllers.PostController Post = new TavanTarkhis.Controllers.T4MVC_PostController();
...
namespace Links {
    ...
    public static class Content {
        ...
        public static class Admin {
            ...
            public static readonly string style_responsive_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/style-responsive.min.css") ? Url("style-responsive.min.css") : Url("style-responsive.css");
        ...
        public static class Images {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string bg_button_png = Url("bg_button.png");
            public static readonly string bgbody_jpg = Url("bgbody.jpg");
            public static readonly string bgline_header_png = Url("bgline-header.png");
            public static readonly string bgliner_jpg = Url("bgliner.jpg");
            public static readonly string bgmenu_png = Url("bgmenu.png");
            public static readonly string block_title_bg_01_png = Url("block-title-bg-01.png");
            public static readonly string block_title_bg_png = Url("block-title-bg.png");
            public static readonly string box_bg_png = Url("box_bg.png");
            public static readonly string facebook_png = Url("facebook.png");
            public static readonly string footer_container_gif = Url("footer_container.gif");
            ...
            public static readonly string selected_bg_png = Url("selected-bg.png");
